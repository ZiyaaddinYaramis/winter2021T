...
public class C2_HashSet01 {
	...
	public static void main(String[] args) {
		...
		// unique (benzersiz) elemanlardan olusan bir Array'e ceviren
		// bir method yaziniz
	...
	public static int[] tekrarlariSil(int[] arr) {
		...
		for (Integer each :arr) {
			set1.add(each);  // (Set'in add methodu ile tekrarlilari yok etmis olduk.. set mantigini tekrar etmelisin)
		}
        ...
        int tekrarsizArray[] = new int[set1.size()]; // 19. satirdaki tekrarsizArray[] farkli bir arraydir. 
		 											 // bu scope konusu ve local
		...
		return tekrarsizArray;  // [] isaretini kabul etmedi acaba neden?
