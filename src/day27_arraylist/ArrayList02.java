...
public class ArrayList02 {
	...
	public static void main(String[] args) {
		...
		list.set(2,"Kemal");  // istemen index'deki elemani kaldirip,
							  // yerine bizim istedigimiz elemani koyar (replace)
		System.out.println(list); // [Ali, Can, Kemal, Fatma]
		
		list.set(0, "Semih");
		System.out.println(list); // [Semih, Can, Kemal, Fatma]
		
		System.out.println(list.set(0, "Semih")); // oldurdugumu getirdim
		...
		list.add(5, "Hurriyet");
		System.out.println(list); // [Semih, Can, Yasin, Kemal, Fatma, Hurriyet]  sonuncuyu ekliyor
		
		//list.add(10, "Sefer"); // size'dan buyuk index kabul etmez
		
		list.contains("Hurriyet");
		...
		Collections.sort(list);  // Java bize kolaylik olsun diye Collections clasini olusturmus
